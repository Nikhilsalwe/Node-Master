...
server.listen(config.httpPort,function(){
	console.log('assas', config)
  console.log("The server is up " + config.port + " in " + config.envName + " and running now");
});
...
//define second handlers function
handlers.foo = function(data, callback){
	//callback send http status code and a payload object
	callback(406, {'name': 'I am foo request'});
};
